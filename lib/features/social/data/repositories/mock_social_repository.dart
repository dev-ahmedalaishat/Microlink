...
class MockSocialRepository implements SocialRepository {
  ...
  final List<User> _mockUsers = [
    const User(
      id: '1',
      name: 'Jane Smith',
      avatarUrl: 'https://ui-avatars.com/api/?name=Jane+Smith&background=008080&color=fff',
    ),
    const User(
      id: '2',
      name: 'John Doe',
      avatarUrl: 'https://ui-avatars.com/api/?name=John+Doe&background=008080&color=fff',
    ),
    const User(
      id: '3',
      name: 'Alice Johnson',
      avatarUrl: 'https://ui-avatars.com/api/?name=Alice+Johnson&background=008080&color=fff',
    ),
  ];
  ...
  void _initializeMockPosts() {
    _mockPosts = [
      ...
      Post(
        id: '2',
        content: 'Community BBQ this Saturday at 4 PM in the main courtyard. Everyone is welcome! Bring your favorite dish.',
        author: _mockUsers[1],
      ...
      Post(
        id: '3',
        content: 'Has anyone seen my cat? He\'s been missing since yesterday. White with brown spots.',
        author: _mockUsers[2],
      ...
      Post(
        id: '4',
        content: 'Thank you to whoever returned my lost wallet! Faith in humanity restored.',
        author: _mockUsers[0],
